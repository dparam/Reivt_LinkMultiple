...
namespace Reivt_LinkMultiple.App.Plugins.LinkMultiple.ExternalEvents
{
    ...
    public class ExternalEvent_Unsubscribe : IExternalEventHandler
    {
        MainViewModel _mainViewModel;


        public ExternalEvent_Unsubscribe(MainViewModel mainViewModel)
        {
        ...
        {
            return "ExternalEvent_Unsubscribe";
        }
    }
}
